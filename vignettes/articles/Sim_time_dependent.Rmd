...
source("vignettes/articles/utils/utils_plotting.R")
```
...
# Load data
train <- readRDS("vignettes/articles/Sim_time_dependent/train.rds")
test <- readRDS("vignettes/articles/Sim_time_dependent/test.rds")
dat <- rbind(train, test)

# Load extracted models
ext_coxtime <- readRDS("vignettes/articles/Sim_time_dependent/extracted_model_coxtime.rds")
ext_deepsurv <- readRDS("vignettes/articles/Sim_time_dependent/extracted_model_deepsurv.rds")
ext_deephit <- readRDS("vignettes/articles/Sim_time_dependent/extracted_model_deephit.rds")
```
...
knitr::include_graphics('vignettes/articles/Sim_time_dependent/sim_td_brier_plot.png')
```
